...
/************** Add By LianZiHao For NVP6134 2017-03-06 Start**********************/

#include "hstSdkADSel.h"


typedef enum
{
	AD_TYPE_NVP6124     = 0x6124,
	AD_TYPE_NVP6134C    = 0x6134,
}AD_TYPE_EN;

/************** Add By LianZiHao For NVP6134 2017-03-06 End **********************/
...
#define NVP6134A_FILE   "/dev/nvp6134"
/************** Modify By LianZiHao For NVP6134 2017-08-10 End **********************/
...
{
    SAMPLE_VI_MODE_4_D1,
    SAMPLE_VI_MODE_8_D1,//add by lianzihao 2017.8.11
    SAMPLE_VI_MODE_16_D1,
    SAMPLE_VI_MODE_16_960H,
    SAMPLE_VI_MODE_16_1280H,
    SAMPLE_VI_MODE_16_HALF720P,

    SAMPLE_VI_MODE_4_720P,//add by lianzihao 2016-07-21
...
typedef enum sample_vi_6124_mode_e
{
    ...
    SAMPLE_VI_MODE_2MUX_D1,   //4mux2 D1
...
typedef struct bitrate_control_para
{
    HI_U32 u32SetGop;
    HI_U32 u32SetFps;
...
HI_S32 SAMPLE_COMM_VENC_Set_RCPara(VENC_CHN VencChn, RATE_CTRL_T *pstRCPara);
HI_S32 SAMPLE_COMM_VENC_Default_RCPara(VENC_CHN VencChn, RATE_CTRL_T *pstRCPara);
...
#if 1//add by lianzihao 20161014 =====================================================>
...
#if 1//add by lianzihao 20170116 =====================================================>
...
HI_S32 SAMPLE_COMM_VI_UnBindVpss(SAMPLE_VI_MODE_E enViMode, VPSS_CHN VpssChn);//modify by lianzihao
...
HI_VOID	SAMPLE_WISDOM_VDEC_ChnAttr(VDEC_CHN_ATTR_S *pstVdecChnAttr, PAYLOAD_TYPE_E enType, SIZE_S *pstSize);
...
HI_S32 SAMPLE_WISDOM_VDEC_BindVpss(VDEC_CHN VdChn, VPSS_GRP VpssGrp, VPSS_CHN VpssChn);
...
HI_S32 SAMPLE_Comm_VO_Disable(VO_DEV VoDev);
...
HI_S32 SAMPLE_WISDOM_VO_StartChn(VO_LAYER VoLayer, VO_CHN VoChn);
...
#if 1 //add by lianzihao 2016-07-25 ==================================================>
...
HI_S32 SAMPLE_COMM_AUDIO_CfgAcodec(AIO_ATTR_S *pstAioAttr,
    AcodecCgf_Type Type, AD_TYPE_EN enCodecType);
HI_S32 SAMPLE_COMM_AUDIO_AUDIO_Pb_Mute(AD_TYPE_EN enCodecType);
