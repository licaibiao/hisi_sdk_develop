#ifndef __NVP6134_H__
#define __NVP6134_H__
...
typedef struct _nvp6134_reg_wr
{
    unsigned char reg;
	unsigned char value;
}nvp6134_reg_wr;
typedef struct _nvp6134_aogain
{
	unsigned char value;
}nvp6134_aogain;
...
/*add by lianzihao for 8 chn ahd camera 2017-11-16*/
#define NVP6134_GET_CODEC_NUM               _IOW(NVP6134_IOC_MAGIC, 0x26, unsigned int)


#define NVP6134_REG_READ    	_IOW(NVP6134_IOC_MAGIC, 0x91, nvp6134_reg_wr)
#define NVP6134_REG_WRITE    	_IOW(NVP6134_IOC_MAGIC, 0x92, nvp6134_reg_wr)
#define NVP6134_AOGAIN_SET    	_IOW(NVP6134_IOC_MAGIC, 0x93, nvp6134_aogain)
